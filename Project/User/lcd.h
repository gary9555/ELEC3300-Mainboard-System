...
void LCD_EraseDot(u8 Xpos, u8 Ypos);
void LCD_DrawChar(u8 Xpage, u8 Ypos, u8 offset);
void LCD_EraseChar(u8 Xpage, u8 YCol);
...
void LCD_EraseLine(u8 Xpos1, u8 Ypos1, u8 Xpos2, u8 Ypos2);
